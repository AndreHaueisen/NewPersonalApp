...
public class Constants {
    ...
    //Fragment TAGS
    public static final String UPCOMING_CLASSES_FRAGMENT_TAG = UpcomingClassesFragment.class.getSimpleName();
    public static final String TO_BE_CONFIRMED_CLASSES_FRAGMENT_TAG = ToBeConfirmedClassesFragment.class.getSimpleName();
